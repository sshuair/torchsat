...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, in_channels=3, num_classes=1000, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(in_channels, planes[0], kernel_size=7, stride=2, padding=3,
                               bias=False)
...
def resnet18(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet.   
                           Note: if pretrained is True, in_channels must be 3 channel.
    """
    ...
    if pretrained and 'in_channel' in kwargs:
